...
assert.equal(result.deepLink.detailTitle,'10월 Kakao Mirror 시험');assert.equal(result.deepLink.query,'kakao-fixture');assert.equal(result.deepLink.shareButton,true);
